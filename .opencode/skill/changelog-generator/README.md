...
**Load**: Ask OpenCode to use the `changelog-generator` skill

---

## Description

Generates changelogs from git commits following established conventions. Automatically detects versioning style and changelog format from existing project files (AGENTS.md, git tags, CHANGELOG.md).
...
- For legacy projects, suggests adding versioning convention to AGENTS.md
